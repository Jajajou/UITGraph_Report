...
HippoRAG \cite{jimenez2024hipporag} mô phỏng cơ chế bộ nhớ dài hạn và dùng Personalized PageRank (PPR) để xếp hạng tri thức theo cấu trúc liên kết, từ đó tăng khả năng kết nối ngữ cảnh và gợi ý multi-hop. Dù vậy, rào cản chính của HippoRAG nằm ở độ phức tạp khi triển khai thực tế, đồng thời thiếu vắng cơ chế chỉ ra rõ cách ràng buộc hiệu lực/phiên bản để tránh trả lời dựa trên văn bản đã hết hiệu lực hoặc đã bị sửa đổi.
