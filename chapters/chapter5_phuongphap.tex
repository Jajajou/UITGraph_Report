...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth,keepaspectratio]{images/img/system_architecture.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth,keepaspectratio]{images/img/lightrag_architecture.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth,keepaspectratio]{images/img/metadata_rag_subgraph.png}
